	...
	internal static class Sbox0
	{
		...
		public static byte Get(int i)
		{
			if (i >= 0 || i < _data.Length)
				return _data[i];
			throw new IndexOutOfRangeException("P0 out of range");
		}

	}

	internal static class Sbox1
	{
		private static readonly byte[] _data =  {
		...
		public static byte Get(int i)
		{
			if (i >= 0 || i < _data.Length)
				return _data[i];
			throw new IndexOutOfRangeException("P1 out of range");
		}

	}

	internal static class Sbox2
	{
		private static readonly byte[] _data =  {
		...
		public static byte Get(int i)
		{
			if (i >= 0 || i < _data.Length)
				return _data[i];
			throw new IndexOutOfRangeException("P2 out of range");
		}

	}

	internal static class Sbox3
	{
		private static readonly byte[] _data =  {
